...
from YuiiChan import SUDO_USERS, dispatcher
from YuiiChan.modules.disable import DisableAbleCommandHandler
from YuiiChan.modules.helper_funcs.chat_status import (bot_admin, can_pin,
                                                           can_promote,
                                                           connection_status,
                                                           user_admin)
...
*Admins only:*
 ...
 • `/zombies`*:* Removes all deleted accounts in the group.
"""
