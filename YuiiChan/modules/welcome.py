...
import YuiiChan.modules.sql.welcome_sql as sql
...
from YuiiChan.modules.helper_funcs.chat_status import is_user_ban_protected, user_admin
from YuiiChan.modules.helper_funcs.misc import build_keyboard, revert_buttons
from YuiiChan.modules.helper_funcs.msg_types import get_welcome_type
from YuiiChan.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from YuiiChan.modules.log_channel import loggable
from YuiiChan.modules.sql.global_bans_sql import is_user_gbanned
        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "Oh! It's My Master, What brings you here?",
                    reply_to_message_id=reply,
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
                    f"#USER_JOINED\n"
                    f"God has arrived in the chat"
                )

            # Welcome Devs
            elif new_mem.id in DEV_USERS:
                update.effective_message.reply_text(
                    "Whoa! A member of the Yui-Chan Club just joined!",
                    reply_to_message_id=reply,
                )
            ...
            # Welcome Support
                ...
                update.effective_message.reply_text(
                    "Huh! Someone with the support just joined!",
                    reply_to_message_id=reply,
                )
            ...
            # Welcome Whitelisted
                ...
                update.effective_message.reply_text(
                    "Oof! A just a sudo joined!", reply_to_message_id=reply
                )
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            # Give the devs a special goodbye
                ...
                update.effective_message.reply_text(
                    "See you later at the Yui-Chan Club!", reply_to_message_id=reply
                )
                return
