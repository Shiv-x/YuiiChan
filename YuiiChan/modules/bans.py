...
def ban(update: Update, context: CallbackContext) -> str:
    ...
    if is_user_ban_protected(chat, user_id, member) and user not in DEV_USERS:
        if user_id == OWNER_ID:
            message.reply_text("Trying to put me against my master and my owner huh?")
            return log_message
        elif user_id in DEV_USERS:
            message.reply_text("I can't act against our own.")
            return log_message
        elif user_id in SUDO_USERS:
            message.reply_text("Why you a fighting with sudos they have guns you know")
            return log_message
        elif user_id in SUPPORT_USERS:
            message.reply_text("Can't bang Support users reeee.")
            return log_message
