    ...
    if platform.system() == "Linux":
        ...
        try:
            ...
            if getprop is not None:
                sdk = asyncio.create_subprocess_exec(
                    getprop, "ro.build.version.sdk", stdout=asyncio.subprocess.PIPE
                )
                ver = asyncio.create_subprocess_exec(
                    getprop, "ro.build.version.release", stdout=asyncio.subprocess.PIPE
                )
                sec = asyncio.create_subprocess_exec(
                    getprop,
