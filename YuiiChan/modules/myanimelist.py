...
*Available commands:*
 - /yanime <anime>: returns information about the anime.
 - /ycharacter <character>: returns information about the character.
 - /ymanga <manga>: returns information about the manga.
 - /yupcoming: returns a list of new anime in the upcoming seasons.
 """

__mod_name__ = "MyAnimeList"
        
        
ANIME_HANDLER = CommandHandler("yanime", anime, pass_args=True)
CHARACTER_HANDLER = CommandHandler("ycharacter", character, pass_args=True)
UPCOMING_HANDLER = CommandHandler("yupcoming", upcoming)
MANGA_HANDLER = CommandHandler("ymanga", manga, pass_args=True)
