...
import YuiiChan.modules.sql.notes_sql as sql
from YuiiChan import dispatcher, LOGGER, OWNER_ID, MESSAGE_DUMP
from YuiiChan.__main__ import DATA_IMPORT
from YuiiChan.modules.helper_funcs.chat_status import user_admin
from YuiiChan.modules.helper_funcs.alternate import typing_action

# from YuiiChan.modules.rules import get_rules
import YuiiChan.modules.sql.rules_sql as rulessql

# from YuiiChan.modules.sql import warns_sql as warnssql
import YuiiChan.modules.sql.blacklist_sql as blacklistsql
from YuiiChan.modules.sql import disable_sql as disabledsql

# from YuiiChan.modules.sql import cust_filters_sql as filtersql
# import YuiiChan.modules.sql.welcome_sql as welcsql
import YuiiChan.modules.sql.locks_sql as locksql
from YuiiChan.modules.connection import connected
...
def export_data(update, context):
    ...
    f = open("Yuii-Chan{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Yuii-Chan{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Yui-ChanBot-Backup` was specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("Yuii-Chan{}.backup".format(chat_id))  # Cleaning file
